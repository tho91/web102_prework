...
let totalAmountRaised = GAMES_JSON.reduce((total, game) => 
...
const displayStr = `
    ...
    has been raised for ${totalGames} game${totalGames === 1 ? '' : 's'}. 
    Currently, ${numUnfundedGames} game${numUnfundedGames === 1 ? '' : 's'} 
    remain unfunded. We need your help to fund these amazing game 
    ${numUnfundedGames === 1 ? '' : 's'}!
    `;

// create a new DOM element containing the template string and 
...
// console.log(fistGame, secondGame);
